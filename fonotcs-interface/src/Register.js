    ...
    <div className='global register'>
      <div className='container register'>
        ...
        <form onSubmit={e => submitRegistration(e)}>
          ...
          {isTeacher ? (
            <div>
              <input type="text" placeholder="Código da turma" value={classId} onChange={e => setClassId(e.target.value)} /><br />
            </div>
          ) : (
            <div>
              <label>Gênero: &nbsp;
              ...
              <input type="text" pattern="[0-9]*" inputmode="numeric" placeholder="Idade" maxLength={2} value={age} onChange={e => setAge(e.target.value.replace(/\D/g, ''))} /><br /><br />
